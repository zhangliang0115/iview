    ...
    <div :class="wrapClasses" :style="styles">
        <div :class="classes">
            <div :class="[prefixCls + '-title']" v-if="showSlotHeader" ref="title">
                <slot name="header">
                    <i-form class="search-form" inline>
                        <Form-item>
                            <i-button class="search-btn" v-for="(button, index) in buttons" :icon="button.icon"
                                      :key="button.text" :type="button.type" :disabled="button.disabled"
                                      @click="buttonEvent(button,$event)">{{button.text}}
                            </i-button>
                        </Form-item>
                        <Form-item>
                            <i-input class="search-body" v-model="searchValue" @on-enter="handleSubmit">
                                <Select v-model="searchField" slot="prepend" style="width: 80px"
                                    ...
                                    <Option v-for="field in searchFields" :key="field.field" :value="field.field">
                                        {{field.title}}
                                    </Option>
                                </Select>
            ...
            <div :class="[prefixCls + '-body']" :style="bodyStyle" ref="body" @scroll="handleBodyScroll"
                ...
                <div v-if="showLoading && !isFirstLoadReMoteData"
                     class="ivu-spin ivu-spin-fix ivu-spin-show-text mask"></div>
            ...
            <div :class="[prefixCls + '-footer']" v-if="showSlotFooter" ref="footer">
                <slot name="footer">
                    <Page class="smart-table-page" :total="total" :current="pageNumber" :page-size="pageSize"
                          :page-size-opts="pageList" size="small" show-elevator show-sizer show-total placement="top"
