...
<template>
    <layout class="layout">
        <layout-item position="left" class="layout-menu-left">
    ...
    <!--<div class="layout" :style="style"  >-->
        <!--<div class="layout-left layout-menu-left"  :style="styleLeft">-->
        <!--</div>-->
        <!--<div ref="layout-right" class="layout-right" :style="styleRight">-->
        <!--</div>-->
    <!--</div>-->
</template>
<script>
    import Layout from "../src/components/layout/layout";
    import LayoutItem from "../src/components/layout/layout-item";
    export default {
        components: {
            LayoutItem,
            Layout},
        ...
        methods:{
            ...
            toggleClick () {
                if (this.leftWith === 200) {
                    this.leftWith = 0;
                } else {
                    this.leftWith = 200;
                }
                this.bus.$emit('layout-right-resize');
            }
        },
        computed:{
            iconSize () {
            ...
            styleLeft(){
                return {
                    width:this.leftWith+"px"
                }
            },
            styleRight(){
                return {
                    width:(document.documentElement.clientWidth-this.leftWith)+"px"
                }
            },
