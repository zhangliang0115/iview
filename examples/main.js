...
Vue.prototype.$.ajaxPrefilter( function(options, originalOptions, jqXHR){
    options.url = 'http://127.0.0.1:1000'+options.url;
...
const router = new VueRouter({
    routes: [
        ...
        {
            path: '/log',
            component: require('./module/操作日志.vue')
        },
        {
            path: '/module',
            component: require('./module/模块管理.vue')
        },
        {
            path: '/menu',
            component: require('./module/菜单管理.vue')
        }
    ]
});
